...
def Random_Forest_Regressor(pollutant,fig_number1,fig_number2,color,dataframe):
 ...
 stages+=[random_forest_regressor]
 ...
 plt.title('Temporal forecasting for '+ pollutant+ ' with Random Forest Regressor')


Random_Forest_Regressor("NO2",1,2,"blue",df)
Random_Forest_Regressor("O3",3,4,"orange",df)
Random_Forest_Regressor("SO2",5,6,"green",df)
Random_Forest_Regressor("CO",7,8,"red",df)
