...
def Gradient_Boosted_Tree_Regressor(pollutant,fig_number1,fig_number2,color,dataframe):
 ...
 gbt_regressor=GBTRegressor(featuresCol="features",labelCol=pollutant,maxIter=25,maxDepth=10,maxBins=32)

 stages+=[gbt_regressor]
 ...
 plt.title('Temporal forecasting for '+ pollutant+ ' with Gradient Boosted Tree Regressor')


Gradient_Boosted_Tree_Regressor("NO2",1,2,"blue",df)
Gradient_Boosted_Tree_Regressor("O3",3,4,"orange",df)
Gradient_Boosted_Tree_Regressor("SO2",5,6,"green",df)
Gradient_Boosted_Tree_Regressor("CO",7,8,"red",df)
